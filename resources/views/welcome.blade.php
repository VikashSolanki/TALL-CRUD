            ...
            @if (Route::has('login'))
                <div class="space-x-4">
                    @auth
                        ...
                        <a href="{{ route('students.list') }}" class="font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150">{{ __('Students') }}</a>
